...
export default function AdminRent() {
    ...
    const getListings = async () => {
        try {
            ...
            setListings(all.filter(l => l.type === 'rent'))
        } catch (err) {
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <div>
                    <div className="flex items-center gap-2">
                        <span className="px-3 py-1 bg-green-100 text-green-800 text-sm font-semibold rounded-full">Rent</span>
                        <h2 className="text-2xl font-bold text-gray-800">Rent Listings</h2>
                    </div>
                    <p className="text-sm text-gray-600 mt-1">Total {filteredListings.length} rent listings</p>
                </div>
                <button
                    onClick={getListings}
                    disabled={loading}
            ...
            <div className="mb-6">
                <div className="relative">
                    <input
                        type="text"
                        placeholder="Search rent listings..."
                        value={searchTerm}
            ...
            {loading && (
                <div className="text-center py-12">
                    ...
                    <p className="mt-2 text-gray-500">Loading rent listings...</p>
                </div>
            )}
                ...
                <>
                    {filteredListings.length === 0 ? (
                        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                            ...
                            <p className="text-gray-500 text-lg">No rent listings found</p>
                        </div>
                    ) : (
                                ...
                                <div key={listing._id} className="border rounded-xl overflow-hidden hover:shadow-xl transition-all group">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="text-xl font-bold text-green-600 mb-2">
                                            ${listing.regularPrice?.toLocaleString()}<span className="text-sm font-normal text-gray-500">/mo</span>
                                        </p>
